...
impl CPP14ParserVisitorCompat<'_> for CppTree {
    ...
    fn visit_pseudoDestructorName(
        &mut self,
        ctx: &PseudoDestructorNameContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_noPointerNewDeclarator(
        &mut self,
        ctx: &NoPointerNewDeclaratorContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_pointerMemberExpression(
        &mut self,
        ctx: &PointerMemberExpressionContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_declarationStatement(
        &mut self,
        ctx: &DeclarationStatementContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_attributeDeclaration(
        &mut self,
        ctx: &AttributeDeclarationContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_trailingTypeSpecifier(
        &mut self,
        ctx: &TrailingTypeSpecifierContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_trailingTypeSpecifierSeq(
        &mut self,
        ctx: &TrailingTypeSpecifierSeqContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_simpleTypeLengthModifier(
        &mut self,
        ctx: &SimpleTypeLengthModifierContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_simpleTypeSignednessModifier(
        &mut self,
        ctx: &SimpleTypeSignednessModifierContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_elaboratedTypeSpecifier(
        &mut self,
        ctx: &ElaboratedTypeSpecifierContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_opaqueEnumDeclaration(
        &mut self,
        ctx: &OpaqueEnumDeclarationContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_enumeratorDefinition(
        &mut self,
        ctx: &EnumeratorDefinitionContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_originalNamespaceName(
        &mut self,
        ctx: &OriginalNamespaceNameContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_namespaceAliasDefinition(
        &mut self,
        ctx: &NamespaceAliasDefinitionContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_qualifiednamespacespecifier(
        &mut self,
        ctx: &QualifiednamespacespecifierContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_linkageSpecification(
        &mut self,
        ctx: &LinkageSpecificationContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_attributeSpecifierSeq(
        &mut self,
        ctx: &AttributeSpecifierSeqContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_attributeArgumentClause(
        &mut self,
        ctx: &AttributeArgumentClauseContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_parametersAndQualifiers(
        &mut self,
        ctx: &ParametersAndQualifiersContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_pointerAbstractDeclarator(
        &mut self,
        ctx: &PointerAbstractDeclaratorContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_noPointerAbstractDeclarator(
        &mut self,
        ctx: &NoPointerAbstractDeclaratorContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_abstractPackDeclarator(
        &mut self,
        ctx: &AbstractPackDeclaratorContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_noPointerAbstractPackDeclarator(
        &mut self,
        ctx: &NoPointerAbstractPackDeclaratorContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_parameterDeclarationClause(
        &mut self,
        ctx: &ParameterDeclarationClauseContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_parameterDeclarationList(
        &mut self,
        ctx: &ParameterDeclarationListContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_braceOrEqualInitializer(
        &mut self,
        ctx: &BraceOrEqualInitializerContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_memberDeclaratorList(
        &mut self,
        ctx: &MemberDeclaratorListContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_conversionFunctionId(
        &mut self,
        ctx: &ConversionFunctionIdContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_conversionDeclarator(
        &mut self,
        ctx: &ConversionDeclaratorContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_constructorInitializer(
        &mut self,
        ctx: &ConstructorInitializerContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_templateparameterList(
        &mut self,
        ctx: &TemplateparameterListContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_templateArgumentList(
        &mut self,
        ctx: &TemplateArgumentListContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_explicitInstantiation(
        &mut self,
        ctx: &ExplicitInstantiationContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_explicitSpecialization(
        &mut self,
        ctx: &ExplicitSpecializationContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_exceptionDeclaration(
        &mut self,
        ctx: &ExceptionDeclarationContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_exceptionSpecification(
        &mut self,
        ctx: &ExceptionSpecificationContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_dynamicExceptionSpecification(
        &mut self,
        ctx: &DynamicExceptionSpecificationContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_noeExceptSpecification(
        &mut self,
        ctx: &NoeExceptSpecificationContext<'_>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
