...
impl CVisitorCompat<'_> for CTree {
    ...
    fn visit_argumentExpressionList(&mut self, ctx: &ArgumentExpressionListContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }
    ...
    fn visit_declarationSpecifiers(&mut self, ctx: &DeclarationSpecifiersContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }

    fn visit_declarationSpecifiers2(&mut self, ctx: &DeclarationSpecifiers2Context<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }

    fn visit_declarationSpecifier(&mut self, ctx: &DeclarationSpecifierContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }
    ...
    fn visit_structOrUnionSpecifier(&mut self, ctx: &StructOrUnionSpecifierContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }
    ...
    fn visit_structDeclarationList(&mut self, ctx: &StructDeclarationListContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }
    ...
    fn visit_specifierQualifierList(&mut self, ctx: &SpecifierQualifierListContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }

    fn visit_structDeclaratorList(&mut self, ctx: &StructDeclaratorListContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }
    ...
    fn visit_gccDeclaratorExtension(&mut self, ctx: &GccDeclaratorExtensionContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }

    fn visit_gccAttributeSpecifier(&mut self, ctx: &GccAttributeSpecifierContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }
    ...
    fn visit_nestedParenthesesBlock(&mut self, ctx: &NestedParenthesesBlockContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }
    ...
    fn visit_directAbstractDeclarator(&mut self, ctx: &DirectAbstractDeclaratorContext<'_>) -> Self::Return {
			    self.visit_children(ctx)
		    }
