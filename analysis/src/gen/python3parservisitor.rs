...
pub trait Python3ParserVisitorCompat<'input>:ParseTreeVisitorCompat<'input, Node= Python3ParserContextType>{
	/**
	 * Visit a parse tree produced by {@link Python3Parser#single_input}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_testlist_star_expr(&mut self, ctx: &Testlist_star_exprContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
