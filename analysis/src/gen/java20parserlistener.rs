...
pub trait Java20ParserListener<'input>: ParseTreeListener<'input, Java20ParserContextType> {
     ...
     * @param ctx the parse tree
     */
    fn enter_unqualifiedMethodIdentifier(
        &mut self,
        _ctx: &UnqualifiedMethodIdentifierContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_unqualifiedMethodIdentifier(
        &mut self,
        _ctx: &UnqualifiedMethodIdentifierContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_singleTypeImportDeclaration(
        &mut self,
        _ctx: &SingleTypeImportDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_singleTypeImportDeclaration(
        &mut self,
        _ctx: &SingleTypeImportDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_typeImportOnDemandDeclaration(
        &mut self,
        _ctx: &TypeImportOnDemandDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_typeImportOnDemandDeclaration(
        &mut self,
        _ctx: &TypeImportOnDemandDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_singleStaticImportDeclaration(
        &mut self,
        _ctx: &SingleStaticImportDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_singleStaticImportDeclaration(
        &mut self,
        _ctx: &SingleStaticImportDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_staticImportOnDemandDeclaration(
        &mut self,
        _ctx: &StaticImportOnDemandDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_staticImportOnDemandDeclaration(
        &mut self,
        _ctx: &StaticImportOnDemandDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_topLevelClassOrInterfaceDeclaration(
        &mut self,
        _ctx: &TopLevelClassOrInterfaceDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_topLevelClassOrInterfaceDeclaration(
        &mut self,
        _ctx: &TopLevelClassOrInterfaceDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_explicitConstructorInvocation(
        &mut self,
        _ctx: &ExplicitConstructorInvocationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_explicitConstructorInvocation(
        &mut self,
        _ctx: &ExplicitConstructorInvocationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_variableArityRecordComponent(
        &mut self,
        _ctx: &VariableArityRecordComponentContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_variableArityRecordComponent(
        &mut self,
        _ctx: &VariableArityRecordComponentContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_normalInterfaceDeclaration(
        &mut self,
        _ctx: &NormalInterfaceDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_normalInterfaceDeclaration(
        &mut self,
        _ctx: &NormalInterfaceDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_annotationInterfaceDeclaration(
        &mut self,
        _ctx: &AnnotationInterfaceDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_annotationInterfaceDeclaration(
        &mut self,
        _ctx: &AnnotationInterfaceDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_annotationInterfaceMemberDeclaration(
        &mut self,
        _ctx: &AnnotationInterfaceMemberDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_annotationInterfaceMemberDeclaration(
        &mut self,
        _ctx: &AnnotationInterfaceMemberDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_annotationInterfaceElementDeclaration(
        &mut self,
        _ctx: &AnnotationInterfaceElementDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_annotationInterfaceElementDeclaration(
        &mut self,
        _ctx: &AnnotationInterfaceElementDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_annotationInterfaceElementModifier(
        &mut self,
        _ctx: &AnnotationInterfaceElementModifierContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_annotationInterfaceElementModifier(
        &mut self,
        _ctx: &AnnotationInterfaceElementModifierContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_localClassOrInterfaceDeclaration(
        &mut self,
        _ctx: &LocalClassOrInterfaceDeclarationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_localClassOrInterfaceDeclaration(
        &mut self,
        _ctx: &LocalClassOrInterfaceDeclarationContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_localVariableDeclarationStatement(
        &mut self,
        _ctx: &LocalVariableDeclarationStatementContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_localVariableDeclarationStatement(
        &mut self,
        _ctx: &LocalVariableDeclarationStatementContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_statementWithoutTrailingSubstatement(
        &mut self,
        _ctx: &StatementWithoutTrailingSubstatementContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_statementWithoutTrailingSubstatement(
        &mut self,
        _ctx: &StatementWithoutTrailingSubstatementContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_ifThenElseStatementNoShortIf(
        &mut self,
        _ctx: &IfThenElseStatementNoShortIfContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_ifThenElseStatementNoShortIf(
        &mut self,
        _ctx: &IfThenElseStatementNoShortIfContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_basicForStatementNoShortIf(
        &mut self,
        _ctx: &BasicForStatementNoShortIfContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_basicForStatementNoShortIf(
        &mut self,
        _ctx: &BasicForStatementNoShortIfContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_enhancedForStatementNoShortIf(
        &mut self,
        _ctx: &EnhancedForStatementNoShortIfContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_enhancedForStatementNoShortIf(
        &mut self,
        _ctx: &EnhancedForStatementNoShortIfContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_classInstanceCreationExpression(
        &mut self,
        _ctx: &ClassInstanceCreationExpressionContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_classInstanceCreationExpression(
        &mut self,
        _ctx: &ClassInstanceCreationExpressionContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_unqualifiedClassInstanceCreationExpression(
        &mut self,
        _ctx: &UnqualifiedClassInstanceCreationExpressionContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_unqualifiedClassInstanceCreationExpression(
        &mut self,
        _ctx: &UnqualifiedClassInstanceCreationExpressionContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_classOrInterfaceTypeToInstantiate(
        &mut self,
        _ctx: &ClassOrInterfaceTypeToInstantiateContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_classOrInterfaceTypeToInstantiate(
        &mut self,
        _ctx: &ClassOrInterfaceTypeToInstantiateContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_arrayCreationExpressionWithoutInitializer(
        &mut self,
        _ctx: &ArrayCreationExpressionWithoutInitializerContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_arrayCreationExpressionWithoutInitializer(
        &mut self,
        _ctx: &ArrayCreationExpressionWithoutInitializerContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_arrayCreationExpressionWithInitializer(
        &mut self,
        _ctx: &ArrayCreationExpressionWithInitializerContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_arrayCreationExpressionWithInitializer(
        &mut self,
        _ctx: &ArrayCreationExpressionWithInitializerContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_unaryExpressionNotPlusMinus(
        &mut self,
        _ctx: &UnaryExpressionNotPlusMinusContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_unaryExpressionNotPlusMinus(
        &mut self,
        _ctx: &UnaryExpressionNotPlusMinusContext<'input>,
    ) {
    }
