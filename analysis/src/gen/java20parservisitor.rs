...
pub trait Java20ParserVisitorCompat<'input>:ParseTreeVisitorCompat<'input, Node= Java20ParserContextType>{
	/**
	 * Visit a parse tree produced by {@link Java20Parser#start}.
	 * @param ctx the parse tree
	 */
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_unqualifiedMethodIdentifier(&mut self, ctx: &UnqualifiedMethodIdentifierContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_ordinaryCompilationUnit(&mut self, ctx: &OrdinaryCompilationUnitContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_modularCompilationUnit(&mut self, ctx: &ModularCompilationUnitContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_singleTypeImportDeclaration(&mut self, ctx: &SingleTypeImportDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_typeImportOnDemandDeclaration(&mut self, ctx: &TypeImportOnDemandDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_singleStaticImportDeclaration(&mut self, ctx: &SingleStaticImportDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_staticImportOnDemandDeclaration(&mut self, ctx: &StaticImportOnDemandDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_topLevelClassOrInterfaceDeclaration(&mut self, ctx: &TopLevelClassOrInterfaceDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_normalClassDeclaration(&mut self, ctx: &NormalClassDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_variableDeclaratorList(&mut self, ctx: &VariableDeclaratorListContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_unannPrimitiveType(&mut self, ctx: &UnannPrimitiveTypeContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_unannReferenceType(&mut self, ctx: &UnannReferenceTypeContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_unannClassOrInterfaceType(&mut self, ctx: &UnannClassOrInterfaceTypeContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_unannInterfaceType(&mut self, ctx: &UnannInterfaceTypeContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_variableArityParameter(&mut self, ctx: &VariableArityParameterContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_instanceInitializer(&mut self, ctx: &InstanceInitializerContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_constructorModifier(&mut self, ctx: &ConstructorModifierContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_constructorDeclarator(&mut self, ctx: &ConstructorDeclaratorContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_explicitConstructorInvocation(&mut self, ctx: &ExplicitConstructorInvocationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_enumConstantModifier(&mut self, ctx: &EnumConstantModifierContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_variableArityRecordComponent(&mut self, ctx: &VariableArityRecordComponentContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_recordComponentModifier(&mut self, ctx: &RecordComponentModifierContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_recordBodyDeclaration(&mut self, ctx: &RecordBodyDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_normalInterfaceDeclaration(&mut self, ctx: &NormalInterfaceDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_constantDeclaration(&mut self, ctx: &ConstantDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_annotationInterfaceDeclaration(&mut self, ctx: &AnnotationInterfaceDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_annotationInterfaceBody(&mut self, ctx: &AnnotationInterfaceBodyContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_annotationInterfaceMemberDeclaration(&mut self, ctx: &AnnotationInterfaceMemberDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_annotationInterfaceElementDeclaration(&mut self, ctx: &AnnotationInterfaceElementDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_annotationInterfaceElementModifier(&mut self, ctx: &AnnotationInterfaceElementModifierContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_elementValuePairList(&mut self, ctx: &ElementValuePairListContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_singleElementAnnotation(&mut self, ctx: &SingleElementAnnotationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_variableInitializerList(&mut self, ctx: &VariableInitializerListContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_localClassOrInterfaceDeclaration(&mut self, ctx: &LocalClassOrInterfaceDeclarationContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_localVariableDeclarationStatement(&mut self, ctx: &LocalVariableDeclarationStatementContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_statementNoShortIf(&mut self, ctx: &StatementNoShortIfContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_statementWithoutTrailingSubstatement(&mut self, ctx: &StatementWithoutTrailingSubstatementContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_labeledStatementNoShortIf(&mut self, ctx: &LabeledStatementNoShortIfContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_statementExpression(&mut self, ctx: &StatementExpressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_ifThenElseStatement(&mut self, ctx: &IfThenElseStatementContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_ifThenElseStatementNoShortIf(&mut self, ctx: &IfThenElseStatementNoShortIfContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_whileStatementNoShortIf(&mut self, ctx: &WhileStatementNoShortIfContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_forStatementNoShortIf(&mut self, ctx: &ForStatementNoShortIfContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_basicForStatementNoShortIf(&mut self, ctx: &BasicForStatementNoShortIfContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_statementExpressionList(&mut self, ctx: &StatementExpressionListContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_enhancedForStatement(&mut self, ctx: &EnhancedForStatementContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_enhancedForStatementNoShortIf(&mut self, ctx: &EnhancedForStatementNoShortIfContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_synchronizedStatement(&mut self, ctx: &SynchronizedStatementContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_catchFormalParameter(&mut self, ctx: &CatchFormalParameterContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_tryWithResourcesStatement(&mut self, ctx: &TryWithResourcesStatementContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_classInstanceCreationExpression(&mut self, ctx: &ClassInstanceCreationExpressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_unqualifiedClassInstanceCreationExpression(&mut self, ctx: &UnqualifiedClassInstanceCreationExpressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_classOrInterfaceTypeToInstantiate(&mut self, ctx: &ClassOrInterfaceTypeToInstantiateContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_arrayCreationExpression(&mut self, ctx: &ArrayCreationExpressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_arrayCreationExpressionWithoutInitializer(&mut self, ctx: &ArrayCreationExpressionWithoutInitializerContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_arrayCreationExpressionWithInitializer(&mut self, ctx: &ArrayCreationExpressionWithInitializerContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_postIncrementExpression(&mut self, ctx: &PostIncrementExpressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_postDecrementExpression(&mut self, ctx: &PostDecrementExpressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_preIncrementExpression(&mut self, ctx: &PreIncrementExpressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_preDecrementExpression(&mut self, ctx: &PreDecrementExpressionContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_lambdaParameterList(&mut self, ctx: &LambdaParameterListContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	 ...
	 * @param ctx the parse tree
	 */
		fn visit_lambdaParameterType(&mut self, ctx: &LambdaParameterTypeContext<'input>) -> Self::Return {
			self.visit_children(ctx)
		}
	...
	T: Java20ParserVisitorCompat<'input>
{
	...
	fn visit_unqualifiedMethodIdentifier(&mut self, ctx: &UnqualifiedMethodIdentifierContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_unqualifiedMethodIdentifier(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_singleTypeImportDeclaration(&mut self, ctx: &SingleTypeImportDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_singleTypeImportDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_typeImportOnDemandDeclaration(&mut self, ctx: &TypeImportOnDemandDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_typeImportOnDemandDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_singleStaticImportDeclaration(&mut self, ctx: &SingleStaticImportDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_singleStaticImportDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_staticImportOnDemandDeclaration(&mut self, ctx: &StaticImportOnDemandDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_staticImportOnDemandDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_topLevelClassOrInterfaceDeclaration(&mut self, ctx: &TopLevelClassOrInterfaceDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_topLevelClassOrInterfaceDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_unannClassOrInterfaceType(&mut self, ctx: &UnannClassOrInterfaceTypeContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_unannClassOrInterfaceType(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_explicitConstructorInvocation(&mut self, ctx: &ExplicitConstructorInvocationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_explicitConstructorInvocation(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_variableArityRecordComponent(&mut self, ctx: &VariableArityRecordComponentContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_variableArityRecordComponent(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_compactConstructorDeclaration(&mut self, ctx: &CompactConstructorDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_compactConstructorDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_normalInterfaceDeclaration(&mut self, ctx: &NormalInterfaceDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_normalInterfaceDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_interfaceMemberDeclaration(&mut self, ctx: &InterfaceMemberDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_interfaceMemberDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_interfaceMethodDeclaration(&mut self, ctx: &InterfaceMethodDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_interfaceMethodDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_annotationInterfaceDeclaration(&mut self, ctx: &AnnotationInterfaceDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_annotationInterfaceDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_annotationInterfaceMemberDeclaration(&mut self, ctx: &AnnotationInterfaceMemberDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_annotationInterfaceMemberDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_annotationInterfaceElementDeclaration(&mut self, ctx: &AnnotationInterfaceElementDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_annotationInterfaceElementDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_annotationInterfaceElementModifier(&mut self, ctx: &AnnotationInterfaceElementModifierContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_annotationInterfaceElementModifier(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_elementValueArrayInitializer(&mut self, ctx: &ElementValueArrayInitializerContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_elementValueArrayInitializer(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_localClassOrInterfaceDeclaration(&mut self, ctx: &LocalClassOrInterfaceDeclarationContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_localClassOrInterfaceDeclaration(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_localVariableDeclarationStatement(&mut self, ctx: &LocalVariableDeclarationStatementContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_localVariableDeclarationStatement(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_statementWithoutTrailingSubstatement(&mut self, ctx: &StatementWithoutTrailingSubstatementContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_statementWithoutTrailingSubstatement(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_labeledStatementNoShortIf(&mut self, ctx: &LabeledStatementNoShortIfContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_labeledStatementNoShortIf(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_ifThenElseStatementNoShortIf(&mut self, ctx: &IfThenElseStatementNoShortIfContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_ifThenElseStatementNoShortIf(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_switchBlockStatementGroup(&mut self, ctx: &SwitchBlockStatementGroupContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_switchBlockStatementGroup(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_basicForStatementNoShortIf(&mut self, ctx: &BasicForStatementNoShortIfContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_basicForStatementNoShortIf(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_enhancedForStatementNoShortIf(&mut self, ctx: &EnhancedForStatementNoShortIfContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_enhancedForStatementNoShortIf(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_tryWithResourcesStatement(&mut self, ctx: &TryWithResourcesStatementContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_tryWithResourcesStatement(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_classInstanceCreationExpression(&mut self, ctx: &ClassInstanceCreationExpressionContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_classInstanceCreationExpression(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_unqualifiedClassInstanceCreationExpression(&mut self, ctx: &UnqualifiedClassInstanceCreationExpressionContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_unqualifiedClassInstanceCreationExpression(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_classOrInterfaceTypeToInstantiate(&mut self, ctx: &ClassOrInterfaceTypeToInstantiateContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_classOrInterfaceTypeToInstantiate(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_arrayCreationExpressionWithoutInitializer(&mut self, ctx: &ArrayCreationExpressionWithoutInitializerContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_arrayCreationExpressionWithoutInitializer(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}

	fn visit_arrayCreationExpressionWithInitializer(&mut self, ctx: &ArrayCreationExpressionWithInitializerContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_arrayCreationExpressionWithInitializer(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
	...
	fn visit_unaryExpressionNotPlusMinus(&mut self, ctx: &UnaryExpressionNotPlusMinusContext<'input>){
		let result = <Self as Java20ParserVisitorCompat>::visit_unaryExpressionNotPlusMinus(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
	}
