...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for Python3ParserExt{
	...
	fn sempred(_localctx: Option<&(dyn Python3ParserContext<'input> + 'input)>, rule_index: isize, pred_index: isize,
			   recog:&mut BaseParserType<'input,I>
	)->bool{
		match rule_index {
					60 => Python3Parser::<'input,I,_>::literal_pattern_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					61 => Python3Parser::<'input,I,_>::literal_expr_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					68 => Python3Parser::<'input,I,_>::pattern_capture_target_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					70 => Python3Parser::<'input,I,_>::value_pattern_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
					97 => Python3Parser::<'input,I,_>::expr_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
			_ => true
		}
	}
}
...
where
    I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>,
{
	fn literal_pattern_sempred(_localctx: Option<&Literal_patternContext<'input>>, pred_index:isize,
	...
	fn literal_expr_sempred(_localctx: Option<&Literal_exprContext<'input>>, pred_index:isize,
						recog:&mut <Self as Deref>::Target
		) -> bool {
		match pred_index {
				1=>{
	...
	fn pattern_capture_target_sempred(_localctx: Option<&Pattern_capture_targetContext<'input>>, pred_index:isize,
						recog:&mut <Self as Deref>::Target
		) -> bool {
		match pred_index {
				2=>{
	...
	fn value_pattern_sempred(_localctx: Option<&Value_patternContext<'input>>, pred_index:isize,
						recog:&mut <Self as Deref>::Target
		) -> bool {
		match pred_index {
				3=>{
...
pub type Single_inputContext<'input> = BaseParserRuleContext<'input,Single_inputContextExt<'input>>;
...
impl<'input> Single_inputContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Single_inputContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Single_inputContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Single_inputContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Single_inputContextExt<'input>>{
...
fn NEWLINE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(NEWLINE, 0)
}
fn simple_stmts(&self) -> Option<Rc<Simple_stmtsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn compound_stmt(&self) -> Option<Rc<Compound_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn single_input(&mut self,)
	-> Result<Rc<Single_inputContextAll<'input>>,ANTLRError> {
		let mut recog = self;
...
impl<'input> File_inputContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<File_inputContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,File_inputContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait File_inputContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<File_inputContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token EOF
/// Returns `None` if there is no child corresponding to token EOF
fn EOF(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(EOF, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token NEWLINE in current rule
fn NEWLINE_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
fn NEWLINE(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn file_input(&mut self,)
	-> Result<Rc<File_inputContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << STRING) | (1usize << NUMBER) | (1usize << ASSERT) | (1usize << ASYNC) | (1usize << AWAIT) | (1usize << BREAK) | (1usize << CLASS) | (1usize << CONTINUE) | (1usize << DEF) | (1usize << DEL) | (1usize << FALSE) | (1usize << FOR) | (1usize << FROM) | (1usize << GLOBAL) | (1usize << IF) | (1usize << IMPORT) | (1usize << LAMBDA) | (1usize << MATCH) | (1usize << NONE) | (1usize << NONLOCAL) | (1usize << NOT) | (1usize << PASS) | (1usize << RAISE) | (1usize << RETURN) | (1usize << TRUE) | (1usize << TRY) | (1usize << UNDERSCORE) | (1usize << WHILE) | (1usize << WITH) | (1usize << YIELD) | (1usize << NEWLINE) | (1usize << NAME) | (1usize << ELLIPSIS) | (1usize << STAR) | (1usize << OPEN_PAREN))) != 0) || ((((_la - 64)) & !0x3f) == 0 && ((1usize << (_la - 64)) & ((1usize << (OPEN_BRACK - 64)) | (1usize << (ADD - 64)) | (1usize << (MINUS - 64)) | (1usize << (NOT_OP - 64)) | (1usize << (OPEN_BRACE - 64)) | (1usize << (AT - 64)))) != 0) {
				...
				match recog.base.input.la(1) {
				 ...
				 DEF | DEL | FALSE | FOR | FROM | GLOBAL | IF | IMPORT | LAMBDA | MATCH |
				 NONE | NONLOCAL | NOT | PASS | RAISE | RETURN | TRUE | TRY | UNDERSCORE |
				 WHILE | WITH | YIELD | NAME | ELLIPSIS | STAR | OPEN_PAREN | OPEN_BRACK |
				 ADD | MINUS | NOT_OP | OPEN_BRACE | AT 
					=> {
						{
						/*InvokeRule stmt*/
...
impl<'input> Eval_inputContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Eval_inputContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Eval_inputContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Eval_inputContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Eval_inputContextExt<'input>>{

fn testlist(&self) -> Option<Rc<TestlistContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token EOF
/// Returns `None` if there is no child corresponding to token EOF
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Eval_inputContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> DecoratorContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DecoratorContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,DecoratorContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait DecoratorContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<DecoratorContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token AT
/// Returns `None` if there is no child corresponding to token AT
fn AT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(AT, 0)
}
fn dotted_name(&self) -> Option<Rc<Dotted_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token NEWLINE
/// Returns `None` if there is no child corresponding to token NEWLINE
...
fn OPEN_PAREN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn CLOSE_PAREN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn decorator(&mut self,)
	-> Result<Rc<DecoratorContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> DecoratorsContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DecoratorsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,DecoratorsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait DecoratorsContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<DecoratorsContextExt<'input>>{

fn decorator_all(&self) ->  Vec<Rc<DecoratorContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn decorator(&self, i: usize) -> Option<Rc<DecoratorContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn decorators(&mut self,)
	-> Result<Rc<DecoratorsContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> DecoratedContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DecoratedContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,DecoratedContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait DecoratedContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<DecoratedContextExt<'input>>{

fn decorators(&self) -> Option<Rc<DecoratorsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn classdef(&self) -> Option<Rc<ClassdefContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn funcdef(&self) -> Option<Rc<FuncdefContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn async_funcdef(&self) -> Option<Rc<Async_funcdefContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn decorated(&mut self,)
	-> Result<Rc<DecoratedContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Async_funcdefContext<'input> = BaseParserRuleContext<'input,Async_funcdefContextExt<'input>>;
...
impl<'input> Async_funcdefContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Async_funcdefContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Async_funcdefContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Async_funcdefContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Async_funcdefContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token ASYNC
/// Returns `None` if there is no child corresponding to token ASYNC
fn ASYNC(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn async_funcdef(&mut self,)
	-> Result<Rc<Async_funcdefContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait FuncdefContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<FuncdefContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token DEF
/// Returns `None` if there is no child corresponding to token DEF
fn DEF(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn COLON(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn ARROW(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(ARROW, 0)
}
fn test(&self) -> Option<Rc<TestContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
pub trait ParametersContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<ParametersContextExt<'input>>{
...
fn typedargslist(&self) -> Option<Rc<TypedargslistContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
pub type TypedargslistContext<'input> = BaseParserRuleContext<'input,TypedargslistContextExt<'input>>;
...
impl<'input> TypedargslistContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypedargslistContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TypedargslistContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait TypedargslistContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<TypedargslistContextExt<'input>>{

fn tfpdef_all(&self) ->  Vec<Rc<TfpdefContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn tfpdef(&self, i: usize) -> Option<Rc<TfpdefContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token STAR
/// Returns `None` if there is no child corresponding to token STAR
fn STAR(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn POWER(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(POWER, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token ASSIGN in current rule
fn ASSIGN_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn ASSIGN(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(ASSIGN, i)
}
fn test_all(&self) ->  Vec<Rc<TestContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn test(&self, i: usize) -> Option<Rc<TestContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
/// Retrieves 'i's TerminalNode corresponding to token COMMA, starting from 0.
/// Returns `None` if number of children corresponding to token COMMA is less or equal than `i`.
fn COMMA(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn typedargslist(&mut self,)
	-> Result<Rc<TypedargslistContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> TfpdefContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TfpdefContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TfpdefContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait TfpdefContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<TfpdefContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn tfpdef(&mut self,)
	-> Result<Rc<TfpdefContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> VarargslistContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<VarargslistContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,VarargslistContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait VarargslistContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<VarargslistContextExt<'input>>{

fn vfpdef_all(&self) ->  Vec<Rc<VfpdefContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn vfpdef(&self, i: usize) -> Option<Rc<VfpdefContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token STAR
/// Returns `None` if there is no child corresponding to token STAR
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn varargslist(&mut self,)
	-> Result<Rc<VarargslistContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> VfpdefContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<VfpdefContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,VfpdefContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait VfpdefContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<VfpdefContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn vfpdef(&mut self,)
	-> Result<Rc<VfpdefContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait StmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<StmtContextExt<'input>>{
...
pub type Simple_stmtsContext<'input> = BaseParserRuleContext<'input,Simple_stmtsContextExt<'input>>;
...
impl<'input> Simple_stmtsContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Simple_stmtsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Simple_stmtsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Simple_stmtsContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Simple_stmtsContextExt<'input>>{

fn simple_stmt_all(&self) ->  Vec<Rc<Simple_stmtContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn simple_stmt(&self, i: usize) -> Option<Rc<Simple_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token NEWLINE
/// Returns `None` if there is no child corresponding to token NEWLINE
...
fn SEMI_COLON_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn SEMI_COLON(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn simple_stmts(&mut self,)
	-> Result<Rc<Simple_stmtsContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Simple_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Simple_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Simple_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Simple_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Simple_stmtContextExt<'input>>{

fn expr_stmt(&self) -> Option<Rc<Expr_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn del_stmt(&self) -> Option<Rc<Del_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn pass_stmt(&self) -> Option<Rc<Pass_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn flow_stmt(&self) -> Option<Rc<Flow_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn import_stmt(&self) -> Option<Rc<Import_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn global_stmt(&self) -> Option<Rc<Global_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn nonlocal_stmt(&self) -> Option<Rc<Nonlocal_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn assert_stmt(&self) -> Option<Rc<Assert_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Simple_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Expr_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Expr_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Expr_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Expr_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Expr_stmtContextExt<'input>>{

fn testlist_star_expr_all(&self) ->  Vec<Rc<Testlist_star_exprContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn testlist_star_expr(&self, i: usize) -> Option<Rc<Testlist_star_exprContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn annassign(&self) -> Option<Rc<AnnassignContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn augassign(&self) -> Option<Rc<AugassignContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn yield_expr_all(&self) ->  Vec<Rc<Yield_exprContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn yield_expr(&self, i: usize) -> Option<Rc<Yield_exprContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn testlist(&self) -> Option<Rc<TestlistContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Expr_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> AnnassignContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AnnassignContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,AnnassignContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait AnnassignContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<AnnassignContextExt<'input>>{
...
fn ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn annassign(&mut self,)
	-> Result<Rc<AnnassignContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Testlist_star_exprContext<'input> = BaseParserRuleContext<'input,Testlist_star_exprContextExt<'input>>;
...
impl<'input> Testlist_star_exprContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Testlist_star_exprContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Testlist_star_exprContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Testlist_star_exprContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Testlist_star_exprContextExt<'input>>{
...
fn star_expr_all(&self) ->  Vec<Rc<Star_exprContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn star_expr(&self, i: usize) -> Option<Rc<Star_exprContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn testlist_star_expr(&mut self,)
...
impl<'input> AugassignContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AugassignContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,AugassignContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait AugassignContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<AugassignContextExt<'input>>{
...
fn ADD_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn SUB_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn MULT_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn AT_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn DIV_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn MOD_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn AND_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn OR_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn XOR_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn LEFT_SHIFT_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn RIGHT_SHIFT_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn POWER_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn IDIV_ASSIGN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn augassign(&mut self,)
	-> Result<Rc<AugassignContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 88)) & !0x3f) == 0 && ((1usize << (_la - 88)) & ((1usize << (ADD_ASSIGN - 88)) | (1usize << (SUB_ASSIGN - 88)) | (1usize << (MULT_ASSIGN - 88)) | (1usize << (AT_ASSIGN - 88)) | (1usize << (DIV_ASSIGN - 88)) | (1usize << (MOD_ASSIGN - 88)) | (1usize << (AND_ASSIGN - 88)) | (1usize << (OR_ASSIGN - 88)) | (1usize << (XOR_ASSIGN - 88)) | (1usize << (LEFT_SHIFT_ASSIGN - 88)) | (1usize << (RIGHT_SHIFT_ASSIGN - 88)) | (1usize << (POWER_ASSIGN - 88)) | (1usize << (IDIV_ASSIGN - 88)))) != 0)) } {
...
impl<'input> Del_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Del_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Del_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Del_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Del_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token DEL
/// Returns `None` if there is no child corresponding to token DEL
fn DEL(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn del_stmt(&mut self,)
	-> Result<Rc<Del_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Pass_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Pass_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Pass_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Pass_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Pass_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token PASS
/// Returns `None` if there is no child corresponding to token PASS
fn PASS(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn pass_stmt(&mut self,)
	-> Result<Rc<Pass_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Flow_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Flow_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Flow_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Flow_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Flow_stmtContextExt<'input>>{

fn break_stmt(&self) -> Option<Rc<Break_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn continue_stmt(&self) -> Option<Rc<Continue_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn return_stmt(&self) -> Option<Rc<Return_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn raise_stmt(&self) -> Option<Rc<Raise_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn yield_stmt(&self) -> Option<Rc<Yield_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn flow_stmt(&mut self,)
	-> Result<Rc<Flow_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Break_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Break_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Break_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Break_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Break_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token BREAK
/// Returns `None` if there is no child corresponding to token BREAK
fn BREAK(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Break_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Continue_stmtContext<'input> = BaseParserRuleContext<'input,Continue_stmtContextExt<'input>>;
...
impl<'input> Continue_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Continue_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Continue_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Continue_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Continue_stmtContextExt<'input>>{
...
fn CONTINUE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn continue_stmt(&mut self,)
	-> Result<Rc<Continue_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Return_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Return_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Return_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Return_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Return_stmtContextExt<'input>>{
...
fn RETURN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Return_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Yield_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Yield_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Yield_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Yield_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Yield_stmtContextExt<'input>>{

fn yield_expr(&self) -> Option<Rc<Yield_exprContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn yield_stmt(&mut self,)
	-> Result<Rc<Yield_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Raise_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Raise_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Raise_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Raise_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Raise_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token RAISE
/// Returns `None` if there is no child corresponding to token RAISE
fn RAISE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn FROM(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn raise_stmt(&mut self,)
	-> Result<Rc<Raise_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Import_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Import_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Import_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Import_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Import_stmtContextExt<'input>>{

fn import_name(&self) -> Option<Rc<Import_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn import_from(&self) -> Option<Rc<Import_fromContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn import_stmt(&mut self,)
	-> Result<Rc<Import_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Import_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Import_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Import_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Import_nameContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Import_nameContextExt<'input>>{
...
fn IMPORT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(IMPORT, 0)
}
fn dotted_as_names(&self) -> Option<Rc<Dotted_as_namesContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn import_name(&mut self,)
	-> Result<Rc<Import_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Import_fromContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Import_fromContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Import_fromContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Import_fromContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Import_fromContextExt<'input>>{
...
fn import_as_names(&self) -> Option<Rc<Import_as_namesContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token CLOSE_PAREN
/// Returns `None` if there is no child corresponding to token CLOSE_PAREN
...
fn DOT_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
/// Retrieves 'i's TerminalNode corresponding to token DOT, starting from 0.
/// Returns `None` if number of children corresponding to token DOT is less or equal than `i`.
fn DOT(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(DOT, i)
}
/// Retrieves all `TerminalNode`s corresponding to token ELLIPSIS in current rule
fn ELLIPSIS_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn ELLIPSIS(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Import_fromContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Import_as_nameContext<'input> = BaseParserRuleContext<'input,Import_as_nameContextExt<'input>>;
...
impl<'input> Import_as_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Import_as_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Import_as_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Import_as_nameContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Import_as_nameContextExt<'input>>{
...
fn AS(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(AS, 0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn import_as_name(&mut self,)
	-> Result<Rc<Import_as_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Dotted_as_nameContext<'input> = BaseParserRuleContext<'input,Dotted_as_nameContextExt<'input>>;
...
impl<'input> Dotted_as_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Dotted_as_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Dotted_as_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Dotted_as_nameContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Dotted_as_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn dotted_as_name(&mut self,)
	-> Result<Rc<Dotted_as_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Import_as_namesContext<'input> = BaseParserRuleContext<'input,Import_as_namesContextExt<'input>>;
...
impl<'input> Import_as_namesContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Import_as_namesContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Import_as_namesContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Import_as_namesContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Import_as_namesContextExt<'input>>{

fn import_as_name_all(&self) ->  Vec<Rc<Import_as_nameContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn import_as_name(&self, i: usize) -> Option<Rc<Import_as_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn import_as_names(&mut self,)
	-> Result<Rc<Import_as_namesContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Dotted_as_namesContext<'input> = BaseParserRuleContext<'input,Dotted_as_namesContextExt<'input>>;
...
impl<'input> Dotted_as_namesContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Dotted_as_namesContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Dotted_as_namesContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Dotted_as_namesContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Dotted_as_namesContextExt<'input>>{

fn dotted_as_name_all(&self) ->  Vec<Rc<Dotted_as_nameContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn dotted_as_name(&self, i: usize) -> Option<Rc<Dotted_as_nameContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn dotted_as_names(&mut self,)
	-> Result<Rc<Dotted_as_namesContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Dotted_nameContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Dotted_nameContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Dotted_nameContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Dotted_nameContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Dotted_nameContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn dotted_name(&mut self,)
	-> Result<Rc<Dotted_nameContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Global_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Global_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Global_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Global_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Global_stmtContextExt<'input>>{
...
fn GLOBAL(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn global_stmt(&mut self,)
	-> Result<Rc<Global_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Nonlocal_stmtContext<'input> = BaseParserRuleContext<'input,Nonlocal_stmtContextExt<'input>>;
...
impl<'input> Nonlocal_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Nonlocal_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Nonlocal_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Nonlocal_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Nonlocal_stmtContextExt<'input>>{
...
fn NONLOCAL(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn nonlocal_stmt(&mut self,)
	-> Result<Rc<Nonlocal_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Assert_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Assert_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Assert_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Assert_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Assert_stmtContextExt<'input>>{
...
fn ASSERT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn COMMA(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn assert_stmt(&mut self,)
	-> Result<Rc<Assert_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Compound_stmtContext<'input> = BaseParserRuleContext<'input,Compound_stmtContextExt<'input>>;
...
impl<'input> Compound_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Compound_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Compound_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Compound_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Compound_stmtContextExt<'input>>{
...
fn try_stmt(&self) -> Option<Rc<Try_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn with_stmt(&self) -> Option<Rc<With_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn funcdef(&self) -> Option<Rc<FuncdefContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
fn decorated(&self) -> Option<Rc<DecoratedContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn async_stmt(&self) -> Option<Rc<Async_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn match_stmt(&self) -> Option<Rc<Match_stmtContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Compound_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Async_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Async_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Async_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Async_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Async_stmtContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn async_stmt(&mut self,)
	-> Result<Rc<Async_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait If_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<If_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token IF
/// Returns `None` if there is no child corresponding to token IF
fn IF(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(IF, 0)
}
fn test_all(&self) ->  Vec<Rc<TestContextAll<'input>>> where Self:Sized{
	self.children_of_type()
...
fn COLON_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn COLON(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn ELIF_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn ELIF(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(ELIF, i)
}
/// Retrieves first TerminalNode corresponding to token ELSE
/// Returns `None` if there is no child corresponding to token ELSE
fn ELSE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
pub trait While_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<While_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token WHILE
/// Returns `None` if there is no child corresponding to token WHILE
fn WHILE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
pub trait For_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<For_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token FOR
/// Returns `None` if there is no child corresponding to token FOR
fn FOR(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn IN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(IN, 0)
}
fn testlist(&self) -> Option<Rc<TestlistContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
impl<'input> Try_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Try_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Try_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Try_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Try_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token TRY
/// Returns `None` if there is no child corresponding to token TRY
fn TRY(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn FINALLY(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(FINALLY, 0)
}
fn except_clause_all(&self) ->  Vec<Rc<Except_clauseContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn except_clause(&self, i: usize) -> Option<Rc<Except_clauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token ELSE
/// Returns `None` if there is no child corresponding to token ELSE
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn try_stmt(&mut self,)
	-> Result<Rc<Try_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> With_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<With_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,With_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait With_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<With_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token WITH
/// Returns `None` if there is no child corresponding to token WITH
fn WITH(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(WITH, 0)
}
fn with_item_all(&self) ->  Vec<Rc<With_itemContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn with_item(&self, i: usize) -> Option<Rc<With_itemContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token COLON
/// Returns `None` if there is no child corresponding to token COLON
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn with_stmt(&mut self,)
	-> Result<Rc<With_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> With_itemContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<With_itemContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,With_itemContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait With_itemContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<With_itemContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn with_item(&mut self,)
	-> Result<Rc<With_itemContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Except_clauseContext<'input> = BaseParserRuleContext<'input,Except_clauseContextExt<'input>>;
...
impl<'input> Except_clauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Except_clauseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Except_clauseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Except_clauseContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Except_clauseContextExt<'input>>{
...
fn EXCEPT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn except_clause(&mut self,)
	-> Result<Rc<Except_clauseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait BlockContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<BlockContextExt<'input>>{
...
fn INDENT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn DEDENT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
impl<'input> Match_stmtContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Match_stmtContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Match_stmtContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Match_stmtContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Match_stmtContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token MATCH
/// Returns `None` if there is no child corresponding to token MATCH
fn MATCH(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(MATCH, 0)
}
fn subject_expr(&self) -> Option<Rc<Subject_exprContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token COLON
/// Returns `None` if there is no child corresponding to token COLON
...
fn case_block_all(&self) ->  Vec<Rc<Case_blockContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn case_block(&self, i: usize) -> Option<Rc<Case_blockContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn match_stmt(&mut self,)
	-> Result<Rc<Match_stmtContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Subject_exprContext<'input> = BaseParserRuleContext<'input,Subject_exprContextExt<'input>>;
...
impl<'input> Subject_exprContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Subject_exprContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Subject_exprContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Subject_exprContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Subject_exprContextExt<'input>>{

fn star_named_expression(&self) -> Option<Rc<Star_named_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token COMMA
/// Returns `None` if there is no child corresponding to token COMMA
...
fn star_named_expressions(&self) -> Option<Rc<Star_named_expressionsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn test(&self) -> Option<Rc<TestContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn subject_expr(&mut self,)
	-> Result<Rc<Subject_exprContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Star_named_expressionsContext<'input> = BaseParserRuleContext<'input,Star_named_expressionsContextExt<'input>>;
...
impl<'input> Star_named_expressionsContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Star_named_expressionsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Star_named_expressionsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Star_named_expressionsContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Star_named_expressionsContextExt<'input>>{
...
fn star_named_expression_all(&self) ->  Vec<Rc<Star_named_expressionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn star_named_expression(&self, i: usize) -> Option<Rc<Star_named_expressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn star_named_expressions(&mut self,)
...
pub type Star_named_expressionContext<'input> = BaseParserRuleContext<'input,Star_named_expressionContextExt<'input>>;
...
impl<'input> Star_named_expressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Star_named_expressionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Star_named_expressionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Star_named_expressionContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Star_named_expressionContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn star_named_expression(&mut self,)
...
impl<'input> Case_blockContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Case_blockContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Case_blockContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Case_blockContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Case_blockContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token CASE
/// Returns `None` if there is no child corresponding to token CASE
fn CASE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn guard(&self) -> Option<Rc<GuardContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn case_block(&mut self,)
	-> Result<Rc<Case_blockContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> GuardContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<GuardContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,GuardContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait GuardContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<GuardContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<GuardContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait PatternsContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<PatternsContextExt<'input>>{

fn open_sequence_pattern(&self) -> Option<Rc<Open_sequence_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
pub trait PatternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<PatternContextExt<'input>>{

fn as_pattern(&self) -> Option<Rc<As_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn or_pattern(&self) -> Option<Rc<Or_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
impl<'input> As_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<As_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,As_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait As_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<As_patternContextExt<'input>>{
...
fn pattern_capture_target(&self) -> Option<Rc<Pattern_capture_targetContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn as_pattern(&mut self,)
	-> Result<Rc<As_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Or_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Or_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Or_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Or_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Or_patternContextExt<'input>>{

fn closed_pattern_all(&self) ->  Vec<Rc<Closed_patternContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn closed_pattern(&self, i: usize) -> Option<Rc<Closed_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token OR_OP in current rule
fn OR_OP_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn OR_OP(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn or_pattern(&mut self,)
	-> Result<Rc<Or_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Closed_patternContext<'input> = BaseParserRuleContext<'input,Closed_patternContextExt<'input>>;
...
impl<'input> Closed_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Closed_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Closed_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Closed_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Closed_patternContextExt<'input>>{

fn literal_pattern(&self) -> Option<Rc<Literal_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn capture_pattern(&self) -> Option<Rc<Capture_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn wildcard_pattern(&self) -> Option<Rc<Wildcard_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn value_pattern(&self) -> Option<Rc<Value_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn group_pattern(&self) -> Option<Rc<Group_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn sequence_pattern(&self) -> Option<Rc<Sequence_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn mapping_pattern(&self) -> Option<Rc<Mapping_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn class_pattern(&self) -> Option<Rc<Class_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn closed_pattern(&mut self,)
	-> Result<Rc<Closed_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Literal_patternContext<'input> = BaseParserRuleContext<'input,Literal_patternContextExt<'input>>;
...
impl<'input> Literal_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Literal_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Literal_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Literal_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Literal_patternContextExt<'input>>{

fn signed_number(&self) -> Option<Rc<Signed_numberContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn complex_number(&self) -> Option<Rc<Complex_numberContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn strings(&self) -> Option<Rc<StringsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token NONE
/// Returns `None` if there is no child corresponding to token NONE
fn NONE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn TRUE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn FALSE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn literal_pattern(&mut self,)
	-> Result<Rc<Literal_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Literal_exprContext<'input> = BaseParserRuleContext<'input,Literal_exprContextExt<'input>>;
...
impl<'input> Literal_exprContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Literal_exprContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Literal_exprContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Literal_exprContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Literal_exprContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn literal_expr(&mut self,)
	-> Result<Rc<Literal_exprContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Complex_numberContext<'input> = BaseParserRuleContext<'input,Complex_numberContextExt<'input>>;
...
impl<'input> Complex_numberContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Complex_numberContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Complex_numberContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Complex_numberContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Complex_numberContextExt<'input>>{

fn signed_real_number(&self) -> Option<Rc<Signed_real_numberContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token ADD
/// Returns `None` if there is no child corresponding to token ADD
fn ADD(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(ADD, 0)
}
fn imaginary_number(&self) -> Option<Rc<Imaginary_numberContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token MINUS
/// Returns `None` if there is no child corresponding to token MINUS
fn MINUS(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn complex_number(&mut self,)
	-> Result<Rc<Complex_numberContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait Signed_numberContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Signed_numberContextExt<'input>>{
...
fn NUMBER(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
pub type Signed_real_numberContext<'input> = BaseParserRuleContext<'input,Signed_real_numberContextExt<'input>>;
...
impl<'input> Signed_real_numberContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Signed_real_numberContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Signed_real_numberContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Signed_real_numberContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Signed_real_numberContextExt<'input>>{

fn real_number(&self) -> Option<Rc<Real_numberContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token MINUS
/// Returns `None` if there is no child corresponding to token MINUS
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn signed_real_number(&mut self,)
...
impl<'input> Real_numberContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Real_numberContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Real_numberContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Real_numberContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Real_numberContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn real_number(&mut self,)
	-> Result<Rc<Real_numberContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Imaginary_numberContext<'input> = BaseParserRuleContext<'input,Imaginary_numberContextExt<'input>>;
...
impl<'input> Imaginary_numberContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Imaginary_numberContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Imaginary_numberContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Imaginary_numberContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Imaginary_numberContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn imaginary_number(&mut self,)
...
pub type Capture_patternContext<'input> = BaseParserRuleContext<'input,Capture_patternContextExt<'input>>;
...
impl<'input> Capture_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Capture_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Capture_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Capture_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Capture_patternContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn capture_pattern(&mut self,)
	-> Result<Rc<Capture_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Pattern_capture_targetContext<'input> = BaseParserRuleContext<'input,Pattern_capture_targetContextExt<'input>>;
...
impl<'input> Pattern_capture_targetContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Pattern_capture_targetContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Pattern_capture_targetContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Pattern_capture_targetContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Pattern_capture_targetContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn pattern_capture_target(&mut self,)
...
pub type Wildcard_patternContext<'input> = BaseParserRuleContext<'input,Wildcard_patternContextExt<'input>>;
...
impl<'input> Wildcard_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Wildcard_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Wildcard_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Wildcard_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Wildcard_patternContextExt<'input>>{
...
fn UNDERSCORE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn wildcard_pattern(&mut self,)
...
pub type Value_patternContext<'input> = BaseParserRuleContext<'input,Value_patternContextExt<'input>>;
...
impl<'input> Value_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Value_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Value_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Value_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Value_patternContextExt<'input>>{

fn attr(&self) -> Option<Rc<AttrContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn value_pattern(&mut self,)
	-> Result<Rc<Value_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> AttrContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AttrContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,AttrContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait AttrContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<AttrContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<AttrContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Name_or_attrContext<'input> = BaseParserRuleContext<'input,Name_or_attrContextExt<'input>>;
...
impl<'input> Name_or_attrContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Name_or_attrContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Name_or_attrContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Name_or_attrContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Name_or_attrContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn name_or_attr(&mut self,)
	-> Result<Rc<Name_or_attrContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Group_patternContext<'input> = BaseParserRuleContext<'input,Group_patternContextExt<'input>>;
...
impl<'input> Group_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Group_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Group_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Group_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Group_patternContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn group_pattern(&mut self,)
	-> Result<Rc<Group_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Sequence_patternContext<'input> = BaseParserRuleContext<'input,Sequence_patternContextExt<'input>>;
...
impl<'input> Sequence_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Sequence_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Sequence_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Sequence_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Sequence_patternContextExt<'input>>{
...
fn OPEN_BRACK(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn CLOSE_BRACK(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(CLOSE_BRACK, 0)
}
fn maybe_sequence_pattern(&self) -> Option<Rc<Maybe_sequence_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token OPEN_PAREN
/// Returns `None` if there is no child corresponding to token OPEN_PAREN
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sequence_pattern(&mut self,)
			...
			match recog.base.input.la(1) {
			 OPEN_BRACK 
				=> {
					...
					recog.base.match_token(CLOSE_BRACK,&mut recog.err_handler)?;
...
pub type Open_sequence_patternContext<'input> = BaseParserRuleContext<'input,Open_sequence_patternContextExt<'input>>;
...
impl<'input> Open_sequence_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Open_sequence_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Open_sequence_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Open_sequence_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Open_sequence_patternContextExt<'input>>{

fn maybe_star_pattern(&self) -> Option<Rc<Maybe_star_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token COMMA
/// Returns `None` if there is no child corresponding to token COMMA
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn open_sequence_pattern(&mut self,)
...
pub type Maybe_sequence_patternContext<'input> = BaseParserRuleContext<'input,Maybe_sequence_patternContextExt<'input>>;
...
impl<'input> Maybe_sequence_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Maybe_sequence_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Maybe_sequence_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Maybe_sequence_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Maybe_sequence_patternContextExt<'input>>{

fn maybe_star_pattern_all(&self) ->  Vec<Rc<Maybe_star_patternContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn maybe_star_pattern(&self, i: usize) -> Option<Rc<Maybe_star_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn maybe_sequence_pattern(&mut self,)
...
pub type Maybe_star_patternContext<'input> = BaseParserRuleContext<'input,Maybe_star_patternContextExt<'input>>;
...
impl<'input> Maybe_star_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Maybe_star_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Maybe_star_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Maybe_star_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Maybe_star_patternContextExt<'input>>{

fn star_pattern(&self) -> Option<Rc<Star_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn pattern(&self) -> Option<Rc<PatternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn maybe_star_pattern(&mut self,)
...
pub type Star_patternContext<'input> = BaseParserRuleContext<'input,Star_patternContextExt<'input>>;
...
impl<'input> Star_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Star_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Star_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Star_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Star_patternContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn star_pattern(&mut self,)
	-> Result<Rc<Star_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Mapping_patternContext<'input> = BaseParserRuleContext<'input,Mapping_patternContextExt<'input>>;
...
impl<'input> Mapping_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Mapping_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Mapping_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Mapping_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Mapping_patternContextExt<'input>>{
...
fn OPEN_BRACE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn CLOSE_BRACE(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(CLOSE_BRACE, 0)
}
fn double_star_pattern(&self) -> Option<Rc<Double_star_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
fn items_pattern(&self) -> Option<Rc<Items_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn mapping_pattern(&mut self,)
	-> Result<Rc<Mapping_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			match  recog.interpreter.adaptive_predict(127,&mut recog.base)? {
				1 =>{
					...
					recog.base.match_token(CLOSE_BRACE,&mut recog.err_handler)?;
...
pub type Items_patternContext<'input> = BaseParserRuleContext<'input,Items_patternContextExt<'input>>;
...
impl<'input> Items_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Items_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Items_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Items_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Items_patternContextExt<'input>>{

fn key_value_pattern_all(&self) ->  Vec<Rc<Key_value_patternContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn key_value_pattern(&self, i: usize) -> Option<Rc<Key_value_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn items_pattern(&mut self,)
	-> Result<Rc<Items_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Key_value_patternContext<'input> = BaseParserRuleContext<'input,Key_value_patternContextExt<'input>>;
...
impl<'input> Key_value_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Key_value_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Key_value_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Key_value_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Key_value_patternContextExt<'input>>{
...
fn literal_expr(&self) -> Option<Rc<Literal_exprContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn attr(&self) -> Option<Rc<AttrContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn key_value_pattern(&mut self,)
...
pub type Double_star_patternContext<'input> = BaseParserRuleContext<'input,Double_star_patternContextExt<'input>>;
...
impl<'input> Double_star_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Double_star_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Double_star_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Double_star_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Double_star_patternContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn double_star_pattern(&mut self,)
...
pub type Class_patternContext<'input> = BaseParserRuleContext<'input,Class_patternContextExt<'input>>;
...
impl<'input> Class_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Class_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Class_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Class_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Class_patternContextExt<'input>>{

fn name_or_attr(&self) -> Option<Rc<Name_or_attrContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token OPEN_PAREN
/// Returns `None` if there is no child corresponding to token OPEN_PAREN
...
fn positional_patterns(&self) -> Option<Rc<Positional_patternsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
fn keyword_patterns(&self) -> Option<Rc<Keyword_patternsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn class_pattern(&mut self,)
	-> Result<Rc<Class_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Positional_patternsContext<'input> = BaseParserRuleContext<'input,Positional_patternsContextExt<'input>>;
...
impl<'input> Positional_patternsContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Positional_patternsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Positional_patternsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Positional_patternsContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Positional_patternsContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn positional_patterns(&mut self,)
...
pub type Keyword_patternsContext<'input> = BaseParserRuleContext<'input,Keyword_patternsContextExt<'input>>;
...
impl<'input> Keyword_patternsContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Keyword_patternsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Keyword_patternsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Keyword_patternsContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Keyword_patternsContextExt<'input>>{

fn keyword_pattern_all(&self) ->  Vec<Rc<Keyword_patternContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn keyword_pattern(&self, i: usize) -> Option<Rc<Keyword_patternContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn keyword_patterns(&mut self,)
...
pub type Keyword_patternContext<'input> = BaseParserRuleContext<'input,Keyword_patternContextExt<'input>>;
...
impl<'input> Keyword_patternContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Keyword_patternContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Keyword_patternContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Keyword_patternContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Keyword_patternContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn keyword_pattern(&mut self,)
	-> Result<Rc<Keyword_patternContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> TestContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TestContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TestContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait TestContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<TestContextExt<'input>>{

fn or_test_all(&self) ->  Vec<Rc<Or_testContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn or_test(&self, i: usize) -> Option<Rc<Or_testContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token IF
/// Returns `None` if there is no child corresponding to token IF
...
fn lambdef(&self) -> Option<Rc<LambdefContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<TestContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.err_handler.sync(&mut recog.base)?;
			match recog.base.input.la(1) {
			 STRING | NUMBER | AWAIT | FALSE | MATCH | NONE | NOT | TRUE | UNDERSCORE |
			 NAME | ELLIPSIS | OPEN_PAREN | OPEN_BRACK | ADD | MINUS | NOT_OP | OPEN_BRACE 
				=> {
					//recog.base.enter_outer_alt(_localctx.clone(), 1);
					recog.base.enter_outer_alt(None, 1);
					{
...
impl<'input> Test_nocondContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Test_nocondContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Test_nocondContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Test_nocondContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Test_nocondContextExt<'input>>{

fn or_test(&self) -> Option<Rc<Or_testContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn lambdef_nocond(&self) -> Option<Rc<Lambdef_nocondContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn test_nocond(&mut self,)
	-> Result<Rc<Test_nocondContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> LambdefContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<LambdefContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,LambdefContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait LambdefContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<LambdefContextExt<'input>>{
...
fn LAMBDA(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn varargslist(&self) -> Option<Rc<VarargslistContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn lambdef(&mut self,)
	-> Result<Rc<LambdefContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Lambdef_nocondContext<'input> = BaseParserRuleContext<'input,Lambdef_nocondContextExt<'input>>;
...
impl<'input> Lambdef_nocondContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Lambdef_nocondContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Lambdef_nocondContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Lambdef_nocondContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Lambdef_nocondContextExt<'input>>{
...
fn test_nocond(&self) -> Option<Rc<Test_nocondContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn varargslist(&self) -> Option<Rc<VarargslistContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn lambdef_nocond(&mut self,)
	-> Result<Rc<Lambdef_nocondContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Or_testContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Or_testContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Or_testContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Or_testContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Or_testContextExt<'input>>{

fn and_test_all(&self) ->  Vec<Rc<And_testContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn and_test(&self, i: usize) -> Option<Rc<And_testContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token OR in current rule
fn OR_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn OR(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(OR, i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn or_test(&mut self,)
	-> Result<Rc<Or_testContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> And_testContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<And_testContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,And_testContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait And_testContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<And_testContextExt<'input>>{

fn not_test_all(&self) ->  Vec<Rc<Not_testContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn not_test(&self, i: usize) -> Option<Rc<Not_testContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves all `TerminalNode`s corresponding to token AND in current rule
fn AND_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn AND(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn and_test(&mut self,)
	-> Result<Rc<And_testContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Not_testContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Not_testContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Not_testContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Not_testContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Not_testContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token NOT
/// Returns `None` if there is no child corresponding to token NOT
fn NOT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(NOT, 0)
}
fn not_test(&self) -> Option<Rc<Not_testContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn not_test(&mut self,)
	-> Result<Rc<Not_testContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			match recog.base.input.la(1) {
			 ...
			 STRING | NUMBER | AWAIT | FALSE | MATCH | NONE | TRUE | UNDERSCORE |
			 NAME | ELLIPSIS | OPEN_PAREN | OPEN_BRACK | ADD | MINUS | NOT_OP | OPEN_BRACE 
				=> {
					//recog.base.enter_outer_alt(_localctx.clone(), 2);
					recog.base.enter_outer_alt(None, 2);
...
pub trait ComparisonContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<ComparisonContextExt<'input>>{
...
fn comp_op_all(&self) ->  Vec<Rc<Comp_opContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn comp_op(&self, i: usize) -> Option<Rc<Comp_opContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
impl<'input> Comp_opContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Comp_opContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Comp_opContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Comp_opContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Comp_opContextExt<'input>>{
...
fn LESS_THAN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn GREATER_THAN(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn EQUALS(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn GT_EQ(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn LT_EQ(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn NOT_EQ_1(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn NOT_EQ_2(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn IS(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(IS, 0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn comp_op(&mut self,)
	-> Result<Rc<Comp_opContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			,
				2 =>{
					...
					recog.base.match_token(GREATER_THAN,&mut recog.err_handler)?;
...
impl<'input> Star_exprContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Star_exprContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Star_exprContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Star_exprContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Star_exprContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn star_expr(&mut self,)
	-> Result<Rc<Star_exprContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait ExprContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<ExprContextExt<'input>>{

fn atom_expr(&self) -> Option<Rc<Atom_exprContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn expr_all(&self) ->  Vec<Rc<ExprContextAll<'input>>> where Self:Sized{
	self.children_of_type()
...
fn ADD_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn ADD(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(ADD, i)
}
/// Retrieves all `TerminalNode`s corresponding to token MINUS in current rule
fn MINUS_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn MINUS(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(MINUS, i)
}
/// Retrieves all `TerminalNode`s corresponding to token NOT_OP in current rule
fn NOT_OP_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn NOT_OP(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn DIV(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn MOD(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn IDIV(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn LEFT_SHIFT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn RIGHT_SHIFT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn AND_OP(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn XOR(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn OR_OP(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ExprContextAll<'input>>,ANTLRError> {
		...
		recog.base.enter_recursion_rule(_localctx.clone(), 194, RULE_expr, _p);
		...
		let result: Result<(), ANTLRError> = try {
			...
			match recog.base.input.la(1) {
			 STRING | NUMBER | AWAIT | FALSE | MATCH | NONE | TRUE | UNDERSCORE |
			 NAME | ELLIPSIS | OPEN_PAREN | OPEN_BRACK | OPEN_BRACE 
				=> {
					{
				...
				=> {
					...
					loop {
						match _alt {
							...
							_la = recog.base.input.la(1);
							if { !(((((_la - 71)) & !0x3f) == 0 && ((1usize << (_la - 71)) & ((1usize << (ADD - 71)) | (1usize << (MINUS - 71)) | (1usize << (NOT_OP - 71)))) != 0)) } {
								recog.err_handler.recover_inline(&mut recog.base)?;
				...
				if _alt==1 {
					...
					,
						2 =>{
							...
							_la = recog.base.input.la(1);
							if { !(((((_la - 56)) & !0x3f) == 0 && ((1usize << (_la - 56)) & ((1usize << (STAR - 56)) | (1usize << (DIV - 56)) | (1usize << (MOD - 56)) | (1usize << (IDIV - 56)) | (1usize << (AT - 56)))) != 0)) } {
								recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input> Atom_exprContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Atom_exprContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Atom_exprContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Atom_exprContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Atom_exprContextExt<'input>>{
...
fn AWAIT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(AWAIT, 0)
}
fn trailer_all(&self) ->  Vec<Rc<TrailerContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn trailer(&self, i: usize) -> Option<Rc<TrailerContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn atom_expr(&mut self,)
	-> Result<Rc<Atom_exprContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait AtomContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<AtomContextExt<'input>>{
...
fn testlist_comp(&self) -> Option<Rc<Testlist_compContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token OPEN_BRACK
/// Returns `None` if there is no child corresponding to token OPEN_BRACK
...
fn dictorsetmaker(&self) -> Option<Rc<DictorsetmakerContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn name(&self) -> Option<Rc<NameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
fn STRING_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn STRING(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
fn ELLIPSIS(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
pub trait NameContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<NameContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token NAME
/// Returns `None` if there is no child corresponding to token NAME
fn NAME(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
pub type Testlist_compContext<'input> = BaseParserRuleContext<'input,Testlist_compContextExt<'input>>;
...
impl<'input> Testlist_compContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Testlist_compContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Testlist_compContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Testlist_compContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Testlist_compContextExt<'input>>{
...
fn comp_for(&self) -> Option<Rc<Comp_forContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn testlist_comp(&mut self,)
	-> Result<Rc<Testlist_compContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> TrailerContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TrailerContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TrailerContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait TrailerContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<TrailerContextExt<'input>>{
...
fn subscriptlist(&self) -> Option<Rc<SubscriptlistContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token CLOSE_BRACK
/// Returns `None` if there is no child corresponding to token CLOSE_BRACK
...
fn DOT(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<TrailerContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type SubscriptlistContext<'input> = BaseParserRuleContext<'input,SubscriptlistContextExt<'input>>;
...
impl<'input> SubscriptlistContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SubscriptlistContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SubscriptlistContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SubscriptlistContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<SubscriptlistContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn subscriptlist(&mut self,)
	-> Result<Rc<SubscriptlistContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait Subscript_ContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Subscript_ContextExt<'input>>{
...
fn sliceop(&self) -> Option<Rc<SliceopContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
impl<'input> SliceopContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SliceopContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SliceopContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SliceopContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<SliceopContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sliceop(&mut self,)
	-> Result<Rc<SliceopContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait ExprlistContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<ExprlistContextExt<'input>>{
		...
		let result: Result<(), ANTLRError> = try {
			...
			while { _alt!=2 && _alt!=INVALID_ALT } {
				if _alt==1 {
					...
					match recog.base.input.la(1) {
					 STRING | NUMBER | AWAIT | FALSE | MATCH | NONE | TRUE | UNDERSCORE |
					 NAME | ELLIPSIS | OPEN_PAREN | OPEN_BRACK | ADD | MINUS | NOT_OP |
					 OPEN_BRACE 
						=> {
							{
							/*InvokeRule expr*/
...
impl<'input> TestlistContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TestlistContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TestlistContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait TestlistContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<TestlistContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn testlist(&mut self,)
	-> Result<Rc<TestlistContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type DictorsetmakerContext<'input> = BaseParserRuleContext<'input,DictorsetmakerContextExt<'input>>;
...
impl<'input> DictorsetmakerContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DictorsetmakerContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,DictorsetmakerContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait DictorsetmakerContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<DictorsetmakerContextExt<'input>>{
...
fn POWER_all(&self) -> Vec<Rc<TerminalNode<'input,Python3ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn POWER(&self, i: usize) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn dictorsetmaker(&mut self,)
	-> Result<Rc<DictorsetmakerContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> ClassdefContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ClassdefContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ClassdefContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ClassdefContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<ClassdefContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token CLASS
/// Returns `None` if there is no child corresponding to token CLASS
fn CLASS(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn classdef(&mut self,)
	-> Result<Rc<ClassdefContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub trait ArglistContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<ArglistContextExt<'input>>{
...
pub trait ArgumentContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<ArgumentContextExt<'input>>{
...
impl<'input> Comp_iterContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Comp_iterContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Comp_iterContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Comp_iterContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Comp_iterContextExt<'input>>{

fn comp_for(&self) -> Option<Rc<Comp_forContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn comp_if(&self) -> Option<Rc<Comp_ifContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn comp_iter(&mut self,)
	-> Result<Rc<Comp_iterContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Comp_forContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Comp_forContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Comp_forContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Comp_forContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Comp_forContextExt<'input>>{
...
fn comp_iter(&self) -> Option<Rc<Comp_iterContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn comp_for(&mut self,)
	-> Result<Rc<Comp_forContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			if (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << ASYNC) | (1usize << FOR) | (1usize << IF))) != 0) {
				{
...
impl<'input> Comp_ifContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Comp_ifContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Comp_ifContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Comp_ifContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Comp_ifContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn comp_if(&mut self,)
	-> Result<Rc<Comp_ifContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Encoding_declContext<'input> = BaseParserRuleContext<'input,Encoding_declContextExt<'input>>;
...
impl<'input> Encoding_declContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Encoding_declContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Encoding_declContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Encoding_declContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Encoding_declContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn encoding_decl(&mut self,)
	-> Result<Rc<Encoding_declContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Yield_exprContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Yield_exprContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Yield_exprContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Yield_exprContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Yield_exprContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token YIELD
/// Returns `None` if there is no child corresponding to token YIELD
fn YIELD(&self) -> Option<Rc<TerminalNode<'input,Python3ParserContextType>>> where Self:Sized{
	self.get_token(YIELD, 0)
}
fn yield_arg(&self) -> Option<Rc<Yield_argContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn yield_expr(&mut self,)
	-> Result<Rc<Yield_exprContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> Yield_argContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Yield_argContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Yield_argContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Yield_argContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<Yield_argContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn yield_arg(&mut self,)
	-> Result<Rc<Yield_argContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> StringsContextExt<'input>{
	fn new(parent: Option<Rc<dyn Python3ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StringsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,StringsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait StringsContextAttrs<'input>: Python3ParserContext<'input> + BorrowMut<StringsContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn strings(&mut self,)
	-> Result<Rc<StringsContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
