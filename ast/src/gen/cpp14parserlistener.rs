...
pub trait CPP14ParserListener<'input>: ParseTreeListener<'input, CPP14ParserContextType> {
     ...
     * @param ctx the parse tree
     */
    fn enter_simpleTypeSignednessModifier(
        &mut self,
        _ctx: &SimpleTypeSignednessModifierContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_simpleTypeSignednessModifier(
        &mut self,
        _ctx: &SimpleTypeSignednessModifierContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_qualifiednamespacespecifier(
        &mut self,
        _ctx: &QualifiednamespacespecifierContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_qualifiednamespacespecifier(
        &mut self,
        _ctx: &QualifiednamespacespecifierContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_noPointerAbstractDeclarator(
        &mut self,
        _ctx: &NoPointerAbstractDeclaratorContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_noPointerAbstractDeclarator(
        &mut self,
        _ctx: &NoPointerAbstractDeclaratorContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_noPointerAbstractPackDeclarator(
        &mut self,
        _ctx: &NoPointerAbstractPackDeclaratorContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_noPointerAbstractPackDeclarator(
        &mut self,
        _ctx: &NoPointerAbstractPackDeclaratorContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_parameterDeclarationClause(
        &mut self,
        _ctx: &ParameterDeclarationClauseContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_parameterDeclarationClause(
        &mut self,
        _ctx: &ParameterDeclarationClauseContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_dynamicExceptionSpecification(
        &mut self,
        _ctx: &DynamicExceptionSpecificationContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_dynamicExceptionSpecification(
        &mut self,
        _ctx: &DynamicExceptionSpecificationContext<'input>,
    ) {
    }
