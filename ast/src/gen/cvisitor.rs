...
pub trait CVisitorCompat<'input>:
    ParseTreeVisitorCompat<'input, Node = CParserContextType>
{
    /**
     * Visit a parse tree produced by {@link CParser#primaryExpression}.
     * @param ctx the parse tree
     ...
     * @param ctx the parse tree
     */
    fn visit_genericAssociation(
        &mut self,
        ctx: &GenericAssociationContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_argumentExpressionList(
        &mut self,
        ctx: &ArgumentExpressionListContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_declarationSpecifiers(
        &mut self,
        ctx: &DeclarationSpecifiersContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_declarationSpecifiers2(
        &mut self,
        ctx: &DeclarationSpecifiers2Context<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_declarationSpecifier(
        &mut self,
        ctx: &DeclarationSpecifierContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_structOrUnionSpecifier(
        &mut self,
        ctx: &StructOrUnionSpecifierContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_structDeclarationList(
        &mut self,
        ctx: &StructDeclarationListContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_specifierQualifierList(
        &mut self,
        ctx: &SpecifierQualifierListContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_structDeclaratorList(
        &mut self,
        ctx: &StructDeclaratorListContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_enumerationConstant(
        &mut self,
        ctx: &EnumerationConstantContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_atomicTypeSpecifier(
        &mut self,
        ctx: &AtomicTypeSpecifierContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_gccDeclaratorExtension(
        &mut self,
        ctx: &GccDeclaratorExtensionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_gccAttributeSpecifier(
        &mut self,
        ctx: &GccAttributeSpecifierContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_nestedParenthesesBlock(
        &mut self,
        ctx: &NestedParenthesesBlockContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_directAbstractDeclarator(
        &mut self,
        ctx: &DirectAbstractDeclaratorContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_externalDeclaration(
        &mut self,
        ctx: &ExternalDeclarationContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
